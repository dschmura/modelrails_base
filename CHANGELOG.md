...
- List-page chrome consistency (#296): the project-memberships table now sits in the same card wrapper (`bg-surface-raised` + border + shadow, surface header row, hover rows) as the workspace-members table, instead of rendering naked. (The members-index header partial the issue also flagged was already adopted in #293.)
