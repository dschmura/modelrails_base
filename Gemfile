...
group :development do
  ...
  gem "modelrails_ui", git: "https://github.com/dschmura/modelrails_ui.git", branch: "harden/wave5-floating-overlays" # (temp: Wave 5a popover; re-pin to modelrails/harden after gem PR #20 merges)
