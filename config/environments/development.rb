...
Rails.application.configure do
  ...
  # Generated modelrails_ui files must converge to the gem template on regeneration;
  # this enables automatic bracket-spacing reformatting to match base's omakase style.
