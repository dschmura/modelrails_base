  ...
  describe "validations" do
    ...
    describe "permissions shape" do
      ...
      it "rejects non-hash permissions" do
        ...
        expect(role.errors[:permissions])
          .to include(I18n.t("activerecord.errors.models.role.attributes.permissions.not_a_hash"))
      end
      ...
      it "rejects non-boolean values" do
        ...
        expect(role.errors[:permissions])
          .to include(I18n.t("activerecord.errors.models.role.attributes.permissions.non_boolean_value"))
      end
